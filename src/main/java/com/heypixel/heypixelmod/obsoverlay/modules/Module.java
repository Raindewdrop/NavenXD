      ...
      try {
         ...
         if (enabled) {
            ...
            if (!(this instanceof ClickGUIModule)) {
               ...
               if (!this.hideInArrayList.getCurrentValue()) {
                  Notification notification = new Notification(NotificationLevel.SUCCESS,  this.name + "§r" + " §aEnabled!", 3000L);
            ...
            if (!(this instanceof ClickGUIModule)) {
               ...
               if (!this.hideInArrayList.getCurrentValue()) {
                  Notification notification = new Notification(NotificationLevel.ERROR,  this.name + "§r" + " §cDisabled!", 3000L);
                  naven.getNotificationManager().addNotification(notification);
               }
            }
         }
