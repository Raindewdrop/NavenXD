...
public class Projectile extends Module {
   ...
   private final BasicProjectileData tntColor = new BasicProjectileData(Collections.singleton(PrimedTnt.class), new Color(255, 0, 0));
   ...
   public BooleanValue showTNT = ValueBuilder.create(this, "Show TNT").setDefaultBooleanValue(false).build().getBooleanValue();
   ...
   private List<ProjectileData> getProjectileInfos() {
      ...
      if (this.showTNT.getCurrentValue()) {
         infos.add(this.tntColor);
      }
