...
public class ClickGUI extends Screen {
   ...
   public ClickGUI() {
      super(Component.nullToEmpty("NavenXD"));
   }
   ...
   public void onShader(EventShader e) {
      if (mc.screen == this) {
         RenderUtils.drawRoundedRect(e.getStack(), windowX, windowY, this.widthAnimation.value, this.heightAnimation.value, 5.0F, Colors.getColor(0, 0, 0, 150));
      }
   }
   ...
   public void render(GuiGraphics g, int mouseX, int mouseY, float pPartialTick) {
      ...
      RenderUtils.drawRoundedRect(stack, windowX, windowY, this.widthAnimation.value, this.heightAnimation.value, 5.0F, Colors.getColor(0, 0, 0, 150));
      ...
      opensans.render(stack, "NavenXD", (double)(windowX + 50.0F - opensans.getWidth("NavenXD", 0.75) / 2.0F), (double)(windowY + 5.0F), Color.WHITE, true, 0.75);
      opensans.setAlpha(1.0F);
      if (this.selectedCategory != null) {
      ...
      if (this.categoryModules != null) {
         ...
         for (Module categoryModule : this.categoryModules) {
            ...
            int enabledColor = Colors.getColor(150, 45, 45, (int)moduleToggleAnimation.value);
         ...
         if (totalHeight > windowHeight - 25.0F) {
            ...
            RenderUtils.drawRoundedRect(
               ...
               barHeight,
               1.5F,
               RenderUtils.reAlpha(Colors.getColor(150, 45, 45, 255), this.moduleAlphaAnimation.value / 255.0F)
            );
         }
      }
      ...
      if (this.renderValues != null) {
         ...
         for (Value value : this.renderValues) {
            if (value.isVisible() && value.getValueType() == ValueType.BOOLEAN) {
               ...
               int enabledColor = Colors.getColor(150, 45, 45, (int)animation.value);
               RenderUtils.drawRoundedRect(
         ...
         for (Value valuex : this.renderValues) {
            if (valuex.isVisible() && valuex.getValueType() == ValueType.FLOAT) {
               ...
               int enabledColor = Colors.getColor(150, 45, 45, 255);
               RenderUtils.drawRoundedRect(
         ...
         for (Value valuexx : this.renderValues) {
            if (valuexx.isVisible() && valuexx.getValueType() == ValueType.MODE) {
               ...
               for (int modeIndex = 0; modeIndex < modeValue.getValues().length; modeIndex++) {
                  ...
                  int enabledColor = Colors.getColor(150, 45, 45, modeValue.isCurrentMode(mode) ? (int)animationx.value : 10);
                  RenderUtils.drawRoundedRect(
         ...
         if (valTotalHeight > windowHeight - 25.0F) {
            ...
            RenderUtils.drawRoundedRect(
               ...
               barHeight,
               1.5F,
               RenderUtils.reAlpha(Colors.getColor(150, 45, 45, 255), this.valuesAlphaAnimation.value / 255.0F)
            );
         }
      }
